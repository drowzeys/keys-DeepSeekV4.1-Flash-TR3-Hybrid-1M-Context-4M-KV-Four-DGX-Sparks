...
[MiaAI-Lab 2× Spark EXL3 2.9 bpw](https://github.com/MiaAI-Lab/DeepSeek-v4.1-Flash-EXL3-2x-DGX-Sparks): **recipe D** — `mia_exl3_wo_b_l10_35.safetensors` + `apply_mia_exl3_wob.py` (not the FP8 sidecar). Instruction-only helper: [keys-DeepSeek-V4.1-Flash-Abliterated-Mia-2x-Spark-EXL3](https://github.com/drowzeys/keys-DeepSeek-V4.1-Flash-Abliterated-Mia-2x-Spark-EXL3).
